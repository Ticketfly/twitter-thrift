...
public class ThriftTest {
    ...
    private ThriftStatsCollector statsCollector;
    ...
    public void setUp() throws Exception {
        ...
        this.statsCollector = control.createMock(ThriftStatsCollector.class);
    ...
    public void testDoCallNoDeadline() throws Exception {
        ...
        statsCollector.add(eq("calculateMass-success"), anyLong());

        Thrift<TestService> thrift = createThrift(expectUnusedExecutorService());

        control.replay();

        int userMass = thrift.builder().blocking()
                .withStatsCollector(statsCollector).create()
                .calculateMass("jake");
    ...
    public void testDoCallAsync() throws Exception {
        ...
        thrift.builder().withConnectTimeout(ASYNC_CONNECT_TIMEOUT)
                .withStatsCollector(statsCollector).create()
    ...
    public void testDoCallServiceException() throws Exception {
        ...
        statsCollector.add(eq("calculateMass-fail"), anyLong());
