...
public class Config {
    ...
    private Config(Config copyFrom) {
        ...
        statsCollector = copyFrom.statsCollector;
    }
    ...
    /**
     * Returns the stats collector to use to record Thrift client stats.
     */
    public ThriftStatsCollector getStatsCollector() {
    ...
    public static abstract class AbstractBuilder<T extends AbstractBuilder> {
        ...
        /**
         * Register a cistom stats collector to track various client stats.
         */
        public T withStatsCollector(ThriftStatsCollector statsCollector) {
            config.statsCollector = Preconditions.checkNotNull(statsCollector);
            return getThis();
        }
