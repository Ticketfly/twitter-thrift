 ...
 * <li> Statistics can be collected through {@link com.twitter.common.thrift.stats.ThriftStatsCollector}
 * {@link #withStatsCollector(com.twitter.common.thrift.stats.ThriftStatsCollector)}
...
public class ThriftFactory<T> {
    private static final Amount<Long, Time> DEFAULT_DEAD_TARGET_RESTORE_INTERVAL = Amount.of(1L, Time.SECONDS);
    ...
    private ObjectPool<Connection<TTransport, InetSocketAddress>> createConnectionPool(
        ...
        Function<InetSocketAddress, ObjectPool<Connection<TTransport, InetSocketAddress>>>
                ...
                new Function<InetSocketAddress, ObjectPool<Connection<TTransport, InetSocketAddress>>>() {
                    @Override
                    public ObjectPool<Connection<TTransport, InetSocketAddress>> apply(
    ...
    /**
     * Register custom stats collector.
     *
     * @param statsCollector the {@code StatsCollector} to use
     * @return A reference to the factory.
     */
    public ThriftFactory<T> withStatsCollector(ThriftStatsCollector statsCollector) {
        this.statsCollector = Preconditions.checkNotNull(statsCollector);
